...
call mvn validate -Didempiere.target=com.btd.getrate.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.btd.getrate.p2.targetplatform %DEBUG_MODE%
