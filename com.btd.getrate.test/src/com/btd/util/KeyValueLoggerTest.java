 ...
 *
 * Copyright (C) 2023 https://btdsistemas.com and contributors (see README.md file).
 */

package com.btd.util;

import static com.btd.test.util.RandomTestUtil.*;
import static com.btd.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.btd.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.btd.util\"");
	}
