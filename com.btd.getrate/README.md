...
- New callout
    * Name: CName
    * Package: com.btd.callout
    * Example: com.btd.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.btd.process
    * Example: com.btd.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.btd.form
    * Example: com.btd.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.btd.event
    * Example: com.btd.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.btd.model
    * Example: com.btd.model.MTableExample
...
- New callout
    * Create callout in package `com.btd.callout`, extends from `CustomCallout`
    * Register callout in `com.btd.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `com.btd.process`, extends from `CustomProcess`
    * Register process in `com.btd.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `com.btd.form`, extends from `CustomForm`
    * Register form in `com.btd.component.FormFactory`. Example:
...
- New event
    * Create event in package `com.btd.event`, extends from `CustomEvent`
    * Register event in `com.btd.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `com.btd.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `com.btd.component.ModelFactory`. Example:
